...
#  $Id: Templar.pod,v 1.8 2001/05/28 20:12:15 deveiant Exp $
#
...
C<Perl 5.6>, C<Class::Translucent>, C<IO::File>, C<IO::Handle>,
C<Scalar::Util>, C<Data::Dumper>, C<Text::Templar::Parser>,
C<Text::Templar::Exceptions>
...
An absolute or relative Unix pathname. If the path has spaces or other unusual
characters, it must be quoted with any valid Perl quoting mechanism. Eg.,

  /www/templates/main.tmpl
...
B<Examples:>
  ...
  <% META rscid q$Id: Templar.pod,v 1.8 2001/05/28 20:12:15 deveiant Exp $>
...
In the template:
  ...
  <% COMMENT %>
    Template RCSID: $Id: Templar.pod,v 1.8 2001/05/28 20:12:15 deveiant Exp $
  <% /COMMENT %>
