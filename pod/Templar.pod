...
#  $Id: Templar.pod,v 1.11 2001/12/31 21:02:57 deveiant Exp $
#
...
B<Examples:>
  ...
  <% META rscid q$Id: Templar.pod,v 1.11 2001/12/31 21:02:57 deveiant Exp $>
...
The fifth and sixth form are hash iterators. They expect a hash or hashref as
the value of C<name>, or as the return value of the specified C<methodchain>
called on the C<name>d object. It iterates over each key/value pair, setting
C<iterator> to a hashref with C<key> and C<value> pairs.
...
In the template:
  ...
  <% COMMENT %>
    Template RCSID: $Id: Templar.pod,v 1.11 2001/12/31 21:02:57 deveiant Exp $
  <% /COMMENT %>
